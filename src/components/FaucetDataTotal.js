...
export default class transactionList extends React.Component {
  ...
  componentDidMount() {
    axios.get(`https://explorer.liberty10.shardeum.org/api/cycleinfo?count=1`).then(res => {
      ...
      axios.get(`https://explorer.liberty10.shardeum.org/api/transaction?startCycle=1&endCycle=${cycleTo}&address=0x1f1545Eb7EE5C3C1c4784ee9ddE5D26A9f76F77C`).then(res => {
