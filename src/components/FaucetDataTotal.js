...
export default class transactionList extends React.Component {
  ...
  componentDidMount() {
    axios.get(`https://explorer.liberty10.shardeum.org/api/cycleinfo?count=1`).then(res => {
      ...
      axios.get(`https://explorer.liberty10.shardeum.org/api/transaction?address=0x1f1545eb7ee5c3c1c4784ee9dde5d26a9f76f77c&startCycle=0&endCycle=${cycleTo}`).then(res => {
  ...
  render() {
    ...
    return (<div>
      ...
      <p>Cycle Range: 1 - {this.state.cycleTo}  </p>
